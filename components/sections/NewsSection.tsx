  ...
  const notices = [
    {
      ...
      date: '2025.12.13',
      isNew: true,
      fullContent: `미리 크리스마스 행사가 12월 13일(토)에 개최됩니다.

      행사 정보:
      - 주최: 전남 시민동호회 연합 (나빌레라 문화센터 열림 대관)
      ...
      - 내용:
        ...
        * 인생 소비 영수증 이벤트
        * 다양한 획기적인 문화 컨텐츠
        * 열림 동호회 딜라이트(D-Light) 공연

      전남 시민동호회 연합이 나빌레라 문화센터 열림을 대관하여 진행하는 특별한 행사입니다.
      다양한 동호회들의 부스 활동과 AI 기술을 활용한 창의적인 컨텐츠,
      그리고 마지막을 장식할 딜라이트의 감동적인 공연까지!

      따뜻한 연말 분위기를 미리 느껴보세요.
      많은 관심과 참여 부탁드립니다.`
    },
    {
      category: '행사',
